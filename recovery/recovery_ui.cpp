...
class Kvim3RecoveryUI : public ScreenRecoveryUI {
  public:
    Kvim3RecoveryUI() {}
...
class Kvim3RecoveryDevice : public Device {
  public:
    Kvim3RecoveryDevice(ScreenRecoveryUI* ui) : Device(ui) {}
...
Device* make_device() {
    ...
    return new Kvim3RecoveryDevice(new Kvim3RecoveryUI());
}
